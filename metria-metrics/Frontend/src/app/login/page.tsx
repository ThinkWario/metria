                    ...
                    <form id="login-form" action={handleSubmit} aria-label="Formulario de inicio de sesión">
                        <CardContent className="space-y-0 flex flex-col gap-0 pb-8">
                            ...
                            <Button
                                type="submit"
                                disabled={isLoading}
                                className="w-full h-11 text-base font-bold transition-all hover:scale-[1.01] active:scale-[0.98] shadow-[0_0_20px_rgba(16,185,129,0.2)] bg-emerald-500 hover:bg-emerald-600 text-white"
                            >
                                {isLoading ? (
                                    <>
